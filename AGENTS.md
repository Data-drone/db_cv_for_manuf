...
Computer vision for manufacturing — Databricks Asset Bundle (DAB) that provisions UC resources, deploys a labeling app, and runs SAM 3.1 finetuning.
...
- **ML:** SAM 3.1 (segment-anything-model), finetuned for object detection
